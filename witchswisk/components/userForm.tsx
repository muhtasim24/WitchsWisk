    ...
    return (
        <div className="w-full">
            ...
            <div className="flex flex-col gap-2 p-2">
                ...
                <button onClick={() => handleLoginMode("signin")} className="px-6 mt-2 py-2 rounded-lg font-semibold transition-all active:scale-95 bg-white text-brand">Login</button>
            </div>
            )}
